...
-- setup de travail (SUPER+SHIFT+W, scripts/start-workspace.sh) : ces apps
-- prennent toujours le même workspace. Note : le workspace *ne peut pas*
-- être passé en option à hl.dsp.exec_cmd() ici — c'est cassé en 0.55 pour
-- tout ce qui fork/wrappe son binaire réel (Brave, Discord, Zed, Claude
-- Desktop) car le suivi se fait par PID du process lancé, pas de la
-- fenêtre. Une règle de classe permanente contourne le problème : elle
-- matche la fenêtre elle-même une fois créée, peu importe le PID.
hl.window_rule({
...
-- terminal du setup de travail : titre dédié pour ne pas matcher tous les
-- autres ghostty flottants (yazi/lazydocker/sesh/...)
hl.window_rule({
	name = "startws-term-float",
	match = { title = "^startws-term$", class = "com.mitchellh.ghostty" },
	workspace = "5 silent",
	float = true,
	center = true,
	size = "700 450",
